...
aa.print("useCustomScriptFile: " + useCustomScriptFile);
if (SA) {
	...
	aa.print("getFunctions: " + useCustomScriptFile);
	eval(getScriptText("INCLUDES_ACCELA_FUNCTIONS",null,useCustomScriptFile));
		aa.print("getFunctions_asb FIXED: " + useCustomScriptFile);
	eval(getScriptText("INCLUDES_ACCELA_FUNCTIONS_ASB",null,useCustomScriptFile));
	aa.print("getFunctionsGlobals: " + useCustomScriptFile);	
	eval(getScriptText("INCLUDES_ACCELA_GLOBALS",null,useCustomScriptFile));
}
	aa.print("getincludesCustom: " + useCustomScriptFile);
...
function getScriptText(vScriptName, servProvCode, useProductScripts) {
	...
	try {
		aa.print("In the getScriptText useProductScripts: " + useProductScripts);
		if (useProductScripts) {
			aa.print("getting masterscripts");
			var emseScript = emseBiz.getMasterScript(aa.getServiceProviderCode(), vScriptName);
		} else {
			aa.print("getting custome");			
