...
function getScriptText(vScriptName) {
	aa.print("SA: " + SA);
aa.print("bzr: " + bzr);
aa.print("doStdChoices: " + doStdChoices );
aa.print("doScripts: " + doScripts);
aa.print("bvr1: " + bvr1);
aa.print("controlString: " +controlString );
aa.print("servProvCode: " + servProvCode);
aa.print("SAScript: " + SAScript);
...
for (thisResult in schedObjArray) {
				...
				for(x in inspObj) {if(typeof(inspObj[x])=="function") {aa.print(x);}}
				for(y in inspObj){if (typeof(inspObj[y])!="function") {aa.print("attribute: " + y + " " + inspObj[y]);}}
				

				aa.print("getInspection: " + inspObj.getInspection());
