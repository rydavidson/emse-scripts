...
//aa.env.setValue("PermitId1", "07EST");
//aa.env.setValue("PermitId2", "00000");
//aa.env.setValue("PermitId3", "00103");
showDebug=true;
//Set partent CAPID for test.
//var parentCapIDModel = aa.cap.getCapIDModel("07WEN", "00000", "00011");
...
cancel=true;
showDebug=true;
aa.print("partialCapId:  " + partialCapId + " parentCapId: " + parentCapId + "is this the renew Process: " + isRenewProcess(parentCapId, partialCapId));
comment("partialCapId:  " + partialCapId + " parentCapId: " + parentCapId + "is this the renew Process: " + isRenewProcess(parentCapId, partialCapId));
...
function copyKeyInfo(srcCapId, targetCapId)
{
	...
	aa.print("srcCapId: " + srcCapId + " targetCapId: " + targetCapId);
...
function copyAppSpecificInfoOld(srcCapId, targetCapId)
{
...
function copyAppSpecificInfo(srcCapId, targetCapId)
{
	...
	copyAppSpecific(AppSpecInfo,targetCapId);
}
	

function editAppSpecific(itemName,itemValue,itemCap)
{
	var itemGroup = null;
...
function copyAppSpecific(AInfo,newCap) // copy all App Specific info into new Cap, 1 optional parameter for ignoreArr
{
