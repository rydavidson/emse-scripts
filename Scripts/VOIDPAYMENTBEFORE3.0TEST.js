/*------------------------------------------------------------------------------------------------------/
| Program : VoidPaymentBefore3.0.js
...
if (SA) {
            eval(getScriptText("INCLUDES_CUSTOME_ERIN", SA));
            eval(getScriptText("INCLUDES_ACCELA_FUNCTIONS_ASB", SA));			
            eval(getScriptText("INCLUDES_ACCELA_GLOBALS_ECS", SA));
            eval(getScriptText(SAScript, SA));
} else {
            eval(getScriptText("INCLUDES_CUSTOME_ERIN"));
            eval(getScriptText("INCLUDES_ACCELA_FUNCTIONS_ASB"));			
            eval(getScriptText("INCLUDES_ACCELA_GLOBALS_ECS"));
}
...
logDebug("in is this before xi:  " + preExecute + " what is prefix: " + prefix);
...
|
/-----------------------------------------------------------------------------------------------------*/
logDebug("doStdChoices: " + doStdChoices + " doScripts: " +doScripts);
	if (typeof(appTypeArray) == "object"){logDebug("yes object");} else {logDebug("not object");}
if (doStdChoices)
            doStandardChoiceActions(controlString,true,0);

if (doScripts)
{logDebug("calling appTypeArray... " + appTypeArray[0]);
doScriptActions();}
